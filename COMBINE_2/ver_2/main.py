...
pred_combine_21_retrain.loc[pred_combine_21_retrain['loss']>MAX_VALUE,:] = MAX_VALUE
pred_combine_21_retrain.loc[pred_combine_21_retrain['loss']<MIN_VALUE,:] = MIN_VALUE
...
pred_combine_21.loc[pred_combine_21['loss']>MAX_VALUE,:] = MAX_VALUE
pred_combine_21.loc[pred_combine_21['loss']<MIN_VALUE,:] = MIN_VALUE
