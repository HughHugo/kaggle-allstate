...
########################################################
head(flds[[1]])
df_stack_index = fread("~/Documents/github/kaggle-allstate/cache/stack_index.csv")
#head(df_stack_index)
...
write.csv(xgb.sub, paste("~/Documents/github/kaggle-allstate/R_XGB_1/xgb.upload_",as.character(Sys.Date()),"_1.csv",sep="")
        , row.names=FALSE, quote=FALSE)
write.csv(preds.t, paste("~/Documents/github/kaggle-allstate/R_XGB_1/RAW.xgb.upload_",as.character(Sys.Date()),"_1.csv",sep="")
        , row.names=FALSE, quote=FALSE)
