...
#### Append stack vector ###
pred_xgb_retrain = pd.read_csv("../LAYER1_XGB/cache/pred_xgb_retrain.csv")
pred_xgb_retrain.columns = ['id', 'XGB_1']
pred_xgb = pd.read_csv("../LAYER1_XGB/cache/pred_xgb.csv")
pred_xgb.columns = ['id', 'XGB_1']
pred_nn_retrain = pd.read_csv("../LAYER1_NN/cache/pred_nn_retrain.csv")
pred_nn_retrain.columns = ['id', 'NN_1']
pred_nn = pd.read_csv("../LAYER1_NN/cache/pred_nn.csv")
pred_nn.columns = ['id', 'NN_1']

train = train.merge(pred_xgb_retrain, how="left", on="id")
train = train.merge(pred_nn_retrain, how="left", on="id")
test = test.merge(pred_xgb, how="left", on="id")
test = test.merge(pred_nn, how="left", on="id")
