...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0]
                         + coord[pe*1]*args[1]
                         + coord[pe*2]*args[2]
                         + coord[pe*3]*args[3]
                         + coord[pe*4]*args[4]
...
print res
args = [
                                       pred_nn_1_fix['loss'].values, #1
                                       pred_nn_2_fix['loss'].values, #2
                                       pred_nn_3_fix['loss'].values, #3
                                       pred_nn_4_fix['loss'].values, #4
                                       pred_nn_5_fix['loss'].values, #5
                                       pred_nn_6_fix['loss'].values, #6
                                       pred_new_nn_1['loss'].values, #7
                                       pred_new_nn_3['loss'].values, #8
                                       pred_nn_1['loss'].values,     #9
                                       pred_nn_2['loss'].values,     #10
                                       pred_nn_3['loss'].values,     #11
                                       pred_nn_4['loss'].values,     #12
                                       pred_nn_5['loss'].values,     #13
                                       pred_nn_6['loss'].values,     #14
        ]
