...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[0]*pred_1 + coord[1]*pred_2 + coord[2]*pred_3
                          ...
                          +coord[9]*pred_8 + coord[10]*pred_11 + coord[11]*pred_12
                          - r))
...
pred_ensemble = (res.x[0]*pred_nn_1_fix + res.x[1]*pred_nn_2_fix + res.x[2]*pred_nn_3_fix
               ...
               + res.x[6]*pred_nn_1 + res.x[7]*pred_nn_2 + res.x[8]*pred_nn_3
               + res.x[9]*pred_nn_4 + res.x[10]*pred_nn_5 + res.x[11]*pred_nn_6
               )
...
tmp = (res.x[0]*pred_nn_1_fix_retrain + res.x[1]*pred_nn_2_fix_retrain + res.x[2]*pred_nn_3_fix_retrain
               ...
               + res.x[6]*pred_nn_1_retrain + res.x[7]*pred_nn_2_retrain + res.x[8]*pred_nn_3_retrain
               + res.x[9]*pred_nn_4_retrain + res.x[10]*pred_nn_5_retrain + res.x[11]*pred_nn_6_retrain
               )
