...
pred_nn_3_retrain = pd.read_csv('../../NN_2/NN_retrain_2.csv', index_col=0)
...
pred_nn_3 = pd.read_csv('../../NN_2/NN_2.csv', index_col=0)
...
# ======================== NN optimize ======================== #
def f(coord,args):
    pred_1,pred_2,pred_3,pred_4,pred_5,pred_6,pred_7,pred_8,pred_9,r = args
    return np.mean( np.abs(coord[0]*pred_1 + coord[1]*pred_2 + coord[2]*pred_3
                          +coord[3]*pred_4 + coord[4]*pred_5 + coord[5]*pred_6
                          +coord[6]*pred_7 + coord[7]*pred_8 + coord[8]*pred_9  - r))
...
pred_ensemble = (res.x[0]*pred_nn_1 + res.x[1]*pred_nn_2 + res.x[2]*pred_nn_3
              ...
              + res.x[6]*pred_xgb_1 + res.x[7]*pred_xgb_2 + res.x[8]*pred_xgb_3)
...
tmp = (res.x[0]*pred_nn_1_retrain + res.x[1]*pred_nn_2_retrain + res.x[2]*pred_nn_3_retrain
              ...
              + res.x[6]*pred_xgb_1_retrain + res.x[7]*pred_xgb_2_retrain + res.x[8]*pred_xgb_3_retrain)
