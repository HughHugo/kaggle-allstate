...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*28+5]
     + coord[pe*28+6]* np.median([ args[0],args[1],args[2],args[3],args[4],args[5] ], axis=0)
     + coord[pe*28+7]* np.median([ args[6],args[7],args[8],args[9],args[10],args[11] ], axis=0)
     + coord[pe*28+8]* np.median([ args[12],args[13],args[14],args[15],args[16],args[17],args[18] ], axis=0)
     + coord[pe*28+9]* np.median([ args[19],args[20]], axis=0)
     + coord[pe*28+10]* np.mean([ args[21],args[22],args[23],args[24],args[25],args[26] ], axis=0)
     + coord[pe*28+11]* np.mean([ args[0],args[1],args[2],args[3],args[4],args[5] ], axis=0)
     + coord[pe*28+12]* np.mean([ args[6],args[7],args[8],args[9],args[10],args[11] ], axis=0)
     + coord[pe*28+13]* np.mean([ args[12],args[13],args[14],args[15],args[16],args[17],args[18] ], axis=0)
     + coord[pe*28+14]* np.mean([ args[19],args[20]], axis=0)
     + coord[pe*28+15]* np.mean([ args[21],args[22],args[23],args[24],args[25],args[26] ], axis=0)
     - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 28 + 16)])
