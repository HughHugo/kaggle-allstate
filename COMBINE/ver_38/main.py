...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*27+0]*(coord[pe*27+6] + args[23] - args[16])
     + coord[pe*27+1]*(coord[pe*27+7] + (args[23]-args[16]) ** 2)
     + coord[pe*27+2]*(coord[pe*27+8] + np.log(abs(args[23]-args[16])))
     + coord[pe*27+3]*(coord[pe*27+9] + 1/(1.0+args[23]-args[16]))
     + coord[pe*27+4]*(coord[pe*27+10] + (abs(args[23]-args[16]) ** 0.5))
     + coord[pe*27+11]*(coord[pe*27+16] + (args[26] - args[16]))
     + coord[pe*27+12]*(coord[pe*27+17] + (args[26]-args[16]) ** 2)
     + coord[pe*27+13]*(coord[pe*27+18] + np.log(abs(args[26]-args[16])))
     + coord[pe*27+14]*(coord[pe*27+19] + 1/(1.0+args[26]-args[16]))
     + coord[pe*27+15]*(coord[pe*27+20] + (abs(args[26]-args[16]) ** 0.5))
     + coord[pe*27+21]
     - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 27 + 22)])
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
 ...
 + res.x[pe*27+0]*(res.x[pe*27+6] + args[23] - args[16])
 + res.x[pe*27+1]*(res.x[pe*27+7] + (args[23]-args[16]) ** 2)
 + res.x[pe*27+2]*(res.x[pe*27+8] + np.log(abs(args[23]-args[16])))
 + res.x[pe*27+3]*(res.x[pe*27+9] + 1/(1.0+args[23]-args[16]))
 + res.x[pe*27+4]*(res.x[pe*27+10] + (abs(args[23]-args[16]) ** 0.5))
 + res.x[pe*27+11]*(res.x[pe*27+16] + (args[26] - args[16]))
 + res.x[pe*27+12]*(res.x[pe*27+17] + (args[26]-args[16]) ** 2)
 + res.x[pe*27+13]*(res.x[pe*27+18] + np.log(abs(args[26]-args[16])))
 + res.x[pe*27+14]*(res.x[pe*27+19] + 1/(1.0+args[26]-args[16]))
 + res.x[pe*27+15]*(res.x[pe*27+20] + (abs(args[26]-args[16]) ** 0.5))
 + res.x[pe*27+21]
 )
