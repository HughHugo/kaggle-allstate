...
pred_gp_retrain = pd.read_csv('../../GP/gp_retrain.csv', index_col=0)
bound_df_retrain(pred_gp_retrain)
...
pred_gp = pd.read_csv('../../GP/gp.csv', index_col=0)
bound_df_test(pred_xgb_9)
...
print "#"
print mean_absolute_error(train['loss'], pred_gp_retrain)
...
initial_guess = np.array([0.1 for x in range(pe * 26 + 6)])
