...
args = [
    ...
    pred_nn_retrain['loss'].values,             #45
    pred_xgb_retrain['loss'].values,            #46
    pred_nn_retrain_gmean['loss'].values,       #47
    pred_xgb_retrain_gmean['loss'].values,      #48
    pred_nn_retrain_sd['loss'].values,          #49
    pred_xgb_retrain_sd['loss'].values,         #50
    pred_nn_retrain_mean_sd_1['loss'].values,   #51
    pred_xgb_retrain_mean_sd_1['loss'].values,  #52
    pred_nn_retrain_mean_sd_2['loss'].values,   #53
    pred_xgb_retrain_mean_sd_2['loss'].values,  #54
    pred_nn_retrain_mean_sd_3['loss'].values,   #55
    pred_xgb_retrain_mean_sd_3['loss'].values,  #56
    pred_nn_retrain_mean_sd_4['loss'].values,   #57
    pred_xgb_retrain_mean_sd_4['loss'].values,  #58
    train['loss'].values
]
...
initial_guess = np.array([np.random.uniform(-0.01,0.01) for x in range(pe * 44 + 13)])
