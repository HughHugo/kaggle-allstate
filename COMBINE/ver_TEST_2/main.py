...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5) + coord[pe*0+5]*(args[0] ** coord[pe*0+6])
                         ...
                         + coord[pe*20]*(args[13] - args[9]) + coord[pe*20+1]*((args[13]-args[9]) ** 2) + coord[pe*20+2]*np.log(abs(args[13]-args[9])) + coord[pe*20+3]*1/(1.0+args[13]-args[9]) + coord[pe*20+4]*(abs(args[13]-args[9]) ** 0.5)
                         - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 21)])
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
              ...
              + res.x[pe*20]*(args[13] - args[9]) + res.x[pe*20+1]*((args[13]-args[9]) ** 2) + res.x[pe*20+2]*np.log(abs(args[13]-args[9])) + res.x[pe*20+3]*1/(1.0+args[13]-args[9]) + res.x[pe*20+4]*(abs(args[13]-args[9]) ** 0.5)
              )
