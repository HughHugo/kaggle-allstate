...
def f(coord,args):
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*20+6]*(args[10] - args[17])
     + coord[pe*20+7]*((args[10]-args[17]) ** 2)
     + coord[pe*20+8]*np.log(1+abs(args[10]-args[17]))
     + coord[pe*20+9]*1/(1.0+args[10]-args[17])
     + coord[pe*20+10]*(abs(args[10]-args[17]) ** 0.5)
     - args[-1]) )
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
 ...
 + res.x[pe*20+0]*(args[19] - args[10])
 + res.x[pe*20+1]*((args[19]-args[10]) ** 2)
 + res.x[pe*20+2]*np.log(1+abs(args[19]-args[10]))
 + res.x[pe*20+3]*1/(1.0+args[19]-args[10])
 + res.x[pe*20+4]*(abs(args[19]-args[10]) ** 0.5)
 + res.x[pe*20+5]
 + res.x[pe*20+6]*(args[19] - args[17])
 + res.x[pe*20+7]*((args[19]-args[17]) ** 2)
 + res.x[pe*20+8]*np.log(1+abs(args[19]-args[17]))
 + res.x[pe*20+9]*1/(1.0+abs(args[19]-args[17]))
 + res.x[pe*20+10]*(abs(args[19]-args[17]) ** 0.5)
 + res.x[pe*20+6]*(args[10] - args[17])
 + res.x[pe*20+7]*((args[10]-args[17]) ** 2)
 + res.x[pe*20+8]*np.log(1+abs(args[10]-args[17]))
 + res.x[pe*20+9]*1/(1.0+args[10]-args[17])
 + res.x[pe*20+10]*(abs(args[10]-args[17]) ** 0.5)
)
...
args = [
    ...
    pred_new_nn_6['loss'],       #12
    pred_new_nn_7['loss'],       #13
    pred_new_nn_1_65['loss'],    #14
    pred_new_nn_2_65['loss'],    #15
    pred_xgb_1['loss'],          #16
    pred_xgb_2['loss'],          #17
    pred_xgb_3['loss'],          #18
    pred_xgb_6['loss'],          #19
