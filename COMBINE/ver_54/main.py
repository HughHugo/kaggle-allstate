...
pred_nn_retrain_gmean = gmean([pred_nn_1_retrain.values,
                pred_nn_2_retrain.values,
                pred_nn_3_retrain.values,
                pred_nn_4_retrain.values,
                pred_nn_5_retrain.values,
...
pred_nn_retrain_sd = np.std([pred_nn_1_retrain.values,
                pred_nn_2_retrain.values,
                pred_nn_3_retrain.values,
                pred_nn_4_retrain.values,
                pred_nn_5_retrain.values,
...
pred_nn_gmean = gmean([pred_nn_1['loss'],
                     pred_nn_2['loss'],
                     pred_nn_3['loss'],
                     pred_nn_4['loss'],
                     pred_nn_5['loss'],
...
pred_nn_sd = np.std([pred_nn_1['loss'],
                     pred_nn_2['loss'],
                     pred_nn_3['loss'],
                     pred_nn_4['loss'],
                     pred_nn_5['loss'],
...
pred_xgb_retrain_gmean = gmean([pred_xgb_1_retrain.values,
                pred_xgb_2_retrain.values,
                pred_xgb_3_retrain.values,
                pred_xgb_6_retrain.values,
                pred_xgb_9_retrain.values,
...
pred_xgb_retrain_sd = np.std([pred_xgb_1_retrain.values,
                pred_xgb_2_retrain.values,
                pred_xgb_3_retrain.values,
                pred_xgb_6_retrain.values,
                pred_xgb_9_retrain.values,
...
pred_xgb_gmean = gmean([pred_xgb_1['loss'],
                      pred_xgb_2['loss'],
                      pred_xgb_3['loss'],
                      pred_xgb_6['loss'],
                      pred_xgb_9['loss'],
...
pred_xgb_sd = np.std([pred_xgb_1['loss'],
                      pred_xgb_2['loss'],
                      pred_xgb_3['loss'],
                      pred_xgb_6['loss'],
                      pred_xgb_9['loss'],
...
args = [
    ...
    pred_nn_retrain,                            #33
    pred_xgb_retrain,                           #34
    pred_nn_retrain_gmean,
    pred_xgb_retrain_gmean,
    pred_nn_retrain_sd,
    pred_xgb_retrain_sd,
    train['loss'].values
]
...
initial_guess = np.array([0.1 for x in range(pe * 32 + 25)])
