...
pred_nn_retrain = np.median([pred_nn_1_retrain.values,
...
print "##"
pred_nn = np.median([pred_nn_1['loss'],
                     pred_nn_2['loss'],
                     pred_nn_3['loss'],
                     pred_nn_4['loss'],
                     pred_nn_5['loss'],
...
pred_xgb_retrain = np.median([pred_xgb_1_retrain.values,
...
pred_xgb = np.median([pred_xgb_1['loss'],
                      pred_xgb_2['loss'],
                      pred_xgb_3['loss'],
                      pred_xgb_6['loss'],
                      pred_xgb_9['loss'],
