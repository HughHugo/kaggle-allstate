...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*26+0]*(args[23] - args[16])
     + coord[pe*26+1]*((args[23]-args[16]) ** 2)
     + coord[pe*26+2]*np.log(abs(args[23]-args[16]))
     + coord[pe*26+3]*1/(1.0+args[23]-args[16])
     + coord[pe*26+4]*(abs(args[23]-args[16]) ** 0.5)
     + coord[pe*26+5]
     + coord[pe*26+6]*(args[25] - args[16])
     + coord[pe*26+7]*((args[25]-args[16]) ** 2)
     + coord[pe*26+8]*np.log(abs(args[25]-args[16]))
     + coord[pe*26+9]*1/(1.0+args[25]-args[16])
     + coord[pe*26+10]*(abs(args[25]-args[16]) ** 0.5)
     + coord[pe*26+6]*(args[25] - args[23])
     + coord[pe*26+7]*((args[25]-args[23]) ** 2)
     + coord[pe*26+8]*np.log(1+abs(args[25]-args[23]))
     + coord[pe*26+9]*1/(1.0+abs(args[25]-args[23]))
     + coord[pe*26+10]*(abs(args[25]-args[23]) ** 0.5)
     - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 26 + 6 + 5 + 5)])
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
 ...
 + res.x[pe*26+5]
 + res.x[pe*26+6]*(args[25] - args[16])
 + res.x[pe*26+7]*((args[25]-args[16]) ** 2)
 + res.x[pe*26+8]*np.log(abs(args[25]-args[16]))
 + res.x[pe*26+9]*1/(1.0+args[25]-args[16])
 + res.x[pe*26+10]*(abs(args[25]-args[16]) ** 0.5)
 + res.x[pe*26+6]*(args[25] - args[23])
 + res.x[pe*26+7]*((args[25]-args[23]) ** 2)
 + res.x[pe*26+8]*np.log(1+abs(args[25]-args[23]))
 + res.x[pe*26+9]*1/(1.0+abs(args[25]-args[23]))
 + res.x[pe*26+10]*(abs(args[25]-args[23]) ** 0.5)
)
