...
initial_guess = np.array([0.1 for x in range(pe * 17)])
...
res = minimize(f,initial_guess,args = [
                                       ...
                                       pred_xgb_1_retrain['loss'].values,    #9
                                       pred_xgb_2_retrain['loss'].values,    #10
                                       pred_xgb_3_retrain['loss'].values,    #11
                                       pred_nn_1_retrain['loss'].values,     #12
                                       pred_nn_2_retrain['loss'].values,     #13
                                       pred_nn_3_retrain['loss'].values,     #14
                                       pred_nn_4_retrain['loss'].values,     #15
                                       pred_nn_5_retrain['loss'].values,     #16
                                       pred_nn_6_retrain['loss'].values,     #17
                                       train['loss'].values
                                       ]
...
args = [
                                       ...
                                       pred_xgb_1_retrain['loss'],    #9
                                       pred_xgb_2_retrain['loss'],    #10
                                       pred_xgb_3_retrain['loss'],    #11
                                       pred_nn_1_retrain['loss'],     #12
                                       pred_nn_2_retrain['loss'],     #13
                                       pred_nn_3_retrain['loss'],     #14
                                       pred_nn_4_retrain['loss'],     #15
                                       pred_nn_5_retrain['loss'],     #16
                                       pred_nn_6_retrain['loss'],     #17
                                       train['loss']
                                       ]
