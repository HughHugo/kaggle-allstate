...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5) + coord[pe*0+5]*(args[0] ** coord[pe*0+6])
                         + coord[pe*1]*args[1] + coord[pe*1+1]*(args[1] ** 2) + coord[pe*1+2]*np.log(args[1]) + coord[pe*1+3]*1/(1.0+args[1]) + coord[pe*1+4]*(args[1] ** 0.5) + coord[pe*1+5]*(args[1] ** coord[pe*1+6])
                         + coord[pe*2]*args[2] + coord[pe*2+1]*(args[2] ** 2) + coord[pe*2+2]*np.log(args[2]) + coord[pe*2+3]*1/(1.0+args[2]) + coord[pe*2+4]*(args[2] ** 0.5) + coord[pe*2+5]*(args[2] ** coord[pe*2+6])
                         + coord[pe*3]*args[3] + coord[pe*3+1]*(args[3] ** 2) + coord[pe*3+2]*np.log(args[3]) + coord[pe*3+3]*1/(1.0+args[3]) + coord[pe*3+4]*(args[3] ** 0.5) + coord[pe*3+5]*(args[3] ** coord[pe*3+6])
                         + coord[pe*4]*args[4] + coord[pe*4+1]*(args[4] ** 2) + coord[pe*4+2]*np.log(args[4]) + coord[pe*4+3]*1/(1.0+args[4]) + coord[pe*4+4]*(args[4] ** 0.5) + coord[pe*4+5]*(args[4] ** coord[pe*4+6])
                         + coord[pe*5]*args[5] + coord[pe*5+1]*(args[5] ** 2) + coord[pe*5+2]*np.log(args[5]) + coord[pe*5+3]*1/(1.0+args[5]) + coord[pe*5+4]*(args[5] ** 0.5) + coord[pe*5+5]*(args[5] ** coord[pe*5+6])
                         + coord[pe*6]*args[6] + coord[pe*6+1]*(args[6] ** 2) + coord[pe*6+2]*np.log(args[6]) + coord[pe*6+3]*1/(1.0+args[6]) + coord[pe*6+4]*(args[6] ** 0.5) + coord[pe*6+5]*(args[6] ** coord[pe*6+6])
                         + coord[pe*7]*args[7] + coord[pe*7+1]*(args[7] ** 2) + coord[pe*7+2]*np.log(args[7]) + coord[pe*7+3]*1/(1.0+args[7]) + coord[pe*7+4]*(args[7] ** 0.5) + coord[pe*7+5]*(args[7] ** coord[pe*7+6])
                         + coord[pe*8]*args[8] + coord[pe*8+1]*(args[8] ** 2) + coord[pe*8+2]*np.log(args[8]) + coord[pe*8+3]*1/(1.0+args[8]) + coord[pe*8+4]*(args[8] ** 0.5) + coord[pe*8+5]*(args[8] ** coord[pe*8+6])
                         + coord[pe*9]*args[9] + coord[pe*9+1]*(args[9] ** 2) + coord[pe*9+2]*np.log(args[9]) + coord[pe*9+3]*1/(1.0+args[9]) + coord[pe*9+4]*(args[9] ** 0.5) + coord[pe*9+5]*(args[9] ** coord[pe*9+6])
                         + coord[pe*10]*args[10] + coord[pe*10+1]*(args[10] ** 2) + coord[pe*10+2]*np.log(args[10]) + coord[pe*10+3]*1/(1.0+args[10]) + coord[pe*10+4]*(args[10] ** 0.5) + coord[pe*10+5]*(args[10] ** coord[pe*10+6])
                         + coord[pe*11]*args[11] + coord[pe*11+1]*(args[11] ** 2) + coord[pe*11+2]*np.log(args[11]) + coord[pe*11+3]*1/(1.0+args[11]) + coord[pe*11+4]*(args[11] ** 0.5) + coord[pe*11+5]*(args[11] ** coord[pe*11+6])
                         + coord[pe*12]*args[12] + coord[pe*12+1]*(args[12] ** 2) + coord[pe*12+2]*np.log(args[12]) + coord[pe*12+3]*1/(1.0+args[12]) + coord[pe*12+4]*(args[12] ** 0.5) + coord[pe*12+5]*(args[12] ** coord[pe*12+6])
                         + coord[pe*13]*args[13] + coord[pe*13+1]*(args[13] ** 2) + coord[pe*13+2]*np.log(args[13]) + coord[pe*13+3]*1/(1.0+args[13]) + coord[pe*13+4]*(args[13] ** 0.5) + coord[pe*13+5]*(args[13] ** coord[pe*13+6])
                         + coord[pe*14]*args[14] + coord[pe*14+1]*(args[14] ** 2) + coord[pe*14+2]*np.log(args[14]) + coord[pe*14+3]*1/(1.0+args[14]) + coord[pe*14+4]*(args[14] ** 0.5) + coord[pe*14+5]*(args[14] ** coord[pe*14+6])
                         + coord[pe*15]*args[15] + coord[pe*15+1]*(args[15] ** 2) + coord[pe*15+2]*np.log(args[15]) + coord[pe*15+3]*1/(1.0+args[15]) + coord[pe*15+4]*(args[15] ** 0.5) + coord[pe*15+5]*(args[15] ** coord[pe*15+6])
                         + coord[pe*16]*args[16] + coord[pe*16+1]*(args[16] ** 2) + coord[pe*16+2]*np.log(args[16]) + coord[pe*16+3]*1/(1.0+args[16]) + coord[pe*16+4]*(args[16] ** 0.5) + coord[pe*16+5]*(args[16] ** coord[pe*16+6])
                         + coord[pe*17]*args[17] + coord[pe*17+1]*(args[17] ** 2) + coord[pe*17+2]*np.log(args[17]) + coord[pe*17+3]*1/(1.0+args[17]) + coord[pe*17+4]*(args[17] ** 0.5) + coord[pe*17+5]*(args[17] ** coord[pe*17+6])
                         + coord[pe*18]*args[18] + coord[pe*18+1]*(args[18] ** 2) + coord[pe*18+2]*np.log(args[18]) + coord[pe*18+3]*1/(1.0+args[18]) + coord[pe*18+4]*(args[18] ** 0.5) + coord[pe*18+5]*(args[18] ** coord[pe*18+6])
                         + coord[pe*19]*args[19] + coord[pe*19+1]*(args[19] ** 2) + coord[pe*19+2]*np.log(args[19]) + coord[pe*19+3]*1/(1.0+args[19]) + coord[pe*19+4]*(args[19] ** 0.5) + coord[pe*19+5]*(args[19] ** coord[pe*19+6])
                         + coord[pe*20+0]*(args[13] - args[9])
                         + coord[pe*20+1]*((args[13]-args[9]) ** 2)
                         + coord[pe*20+2]*np.log(abs(args[13]-args[9]))
                         + coord[pe*20+3]*1/(1.0+args[13]-args[9])
                         + coord[pe*20+4]*(abs(args[13]-args[9]) ** 0.5)
                         + (coord[pe*20+5] * args[13] ** coord[pe*20+6])
                         + (coord[pe*20+7] * args[9] ** coord[pe*20+8])
                         + (coord[pe*20+9] * args[9] ** coord[pe*20+10]) * (coord[pe*20+11] * args[13] ** coord[pe*20+12])
                         - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 20 + 13)])
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
              ...
              + res.x[pe*19]*args[19] + res.x[pe*19+1]*(args[19] ** 2) + res.x[pe*19+2]*np.log(args[19]) + res.x[pe*19+3]*1/(1.0+args[19]) + res.x[pe*19+4]*(args[19] ** 0.5)
                         + res.x[pe*20+0]*(args[13] - args[9])
                         + res.x[pe*20+1]*((args[13]-args[9]) ** 2)
                         + res.x[pe*20+2]*np.log(abs(args[13]-args[9]))
                         + res.x[pe*20+3]*1/(1.0+args[13]-args[9])
                         + res.x[pe*20+4]*(abs(args[13]-args[9]) ** 0.5)
                         + (res.x[pe*20+5] * args[13] ** res.x[pe*20+6])
                         + (res.x[pe*20+7] * args[9] ** res.x[pe*20+8])
                         + (res.x[pe*20+9] * args[9] ** res.x[pe*20+10]) * (res.x[pe*20+11] * args[13] ** res.x[pe*20+12])
