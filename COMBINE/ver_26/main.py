...
pred_new_nn_2_LEAK_retrain = pd.read_csv('../../NEW_NN_2_LEAK/NN_retrain_2.csv', index_col=0)
bound_df_retrain(pred_new_nn_2_LEAK_retrain)
pred_new_nn_7_LEAK_retrain = pd.read_csv('../../NEW_NN_7_LEAK/NN_retrain_7.csv', index_col=0)
bound_df_retrain(pred_new_nn_7_LEAK_retrain)

pred_xgb_9_LEAK_retrain = pd.read_csv('../../XGB_9_LEAK/XGB_retrain_9.csv', index_col=0)
bound_df_retrain(pred_xgb_9_LEAK_retrain)
...
pred_new_nn_2_LEAK = pd.read_csv('../../NEW_NN_2_LEAK/NN_2.csv', index_col=0)
bound_df_test(pred_new_nn_2_LEAK)
pred_new_nn_7_LEAK = pd.read_csv('../../NEW_NN_7_LEAK/NN_7.csv', index_col=0)
bound_df_test(pred_new_nn_7_LEAK)

pred_xgb_9_LEAK = pd.read_csv('../../XGB_9_LEAK/XGB_9.csv', index_col=0)
bound_df_test(pred_xgb_9_LEAK)
...
print "#"
print mean_absolute_error(train['loss'], pred_new_nn_2_LEAK_retrain)
print mean_absolute_error(train['loss'], pred_new_nn_7_LEAK_retrain)
print mean_absolute_error(train['loss'], pred_xgb_9_LEAK_retrain)
...
args = [
    ...
    pred_new_nn_2_LEAK_retrain['loss'].values,  #27
    pred_new_nn_7_LEAK_retrain['loss'].values,  #28
    pred_xgb_9_LEAK_retrain['loss'].values,     #29
    train['loss'].values
]
...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*29+0]*(args[23] - args[16])
     + coord[pe*29+1]*((args[23]-args[16]) ** 2)
     + coord[pe*29+2]*np.log(abs(args[23]-args[16]))
     + coord[pe*29+3]*1/(1.0+args[23]-args[16])
     + coord[pe*29+4]*(abs(args[23]-args[16]) ** 0.5)
     + coord[pe*29+5]
     + coord[pe*29+6]*(args[25] - args[16])
     + coord[pe*29+7]*((args[25]-args[16]) ** 2)
     + coord[pe*29+8]*np.log(abs(args[25]-args[16]))
     + coord[pe*29+9]*1/(1.0+args[25]-args[16])
     + coord[pe*29+10]*(abs(args[25]-args[16]) ** 0.5)
     + coord[pe*29+6]*(args[25] - args[23])
     + coord[pe*29+7]*((args[25]-args[23]) ** 2)
     + coord[pe*29+8]*np.log(1+abs(args[25]-args[23]))
     + coord[pe*29+9]*1/(1.0+abs(args[25]-args[23]))
     + coord[pe*29+10]*(abs(args[25]-args[23]) ** 0.5)
     - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 29 + 6 + 5 + 5)])
...
pred_ensemble = (res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5)
 ...
 + res.x[pe*29+0]*(args[23] - args[16])
 + res.x[pe*29+1]*((args[23]-args[16]) ** 2)
 + res.x[pe*29+2]*np.log(abs(args[23]-args[16]))
 + res.x[pe*29+3]*1/(1.0+args[23]-args[16])
 + res.x[pe*29+4]*(abs(args[23]-args[16]) ** 0.5)
 + res.x[pe*29+5]
 + res.x[pe*29+6]*(args[25] - args[16])
 + res.x[pe*29+7]*((args[25]-args[16]) ** 2)
 + res.x[pe*29+8]*np.log(abs(args[25]-args[16]))
 + res.x[pe*29+9]*1/(1.0+args[25]-args[16])
 + res.x[pe*29+10]*(abs(args[25]-args[16]) ** 0.5)
 + res.x[pe*29+6]*(args[25] - args[23])
 + res.x[pe*29+7]*((args[25]-args[23]) ** 2)
 + res.x[pe*29+8]*np.log(1+abs(args[25]-args[23]))
 + res.x[pe*29+9]*1/(1.0+abs(args[25]-args[23]))
 + res.x[pe*29+10]*(abs(args[25]-args[23]) ** 0.5)
)
...
args = [
    ...
    pred_xgb_6['loss'],          #25
    pred_xgb_9['loss'],          #26
    pred_new_nn_2_LEAK['loss'],  #27
    pred_new_nn_7_LEAK['loss'],  #28
    pred_xgb_9_LEAK['loss'],     #29
]
