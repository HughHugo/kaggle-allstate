...
args = [
    ...
    pred_nn_retrain['loss'].values,             #48
    pred_xgb_retrain['loss'].values,            #49
    pred_nn_retrain_gmean['loss'].values,       #50
    pred_xgb_retrain_gmean['loss'].values,      #51
    pred_nn_retrain_sd['loss'].values,          #52
    pred_xgb_retrain_sd['loss'].values,         #53
    pred_nn_retrain_mean_sd_1['loss'].values,   #54
    pred_xgb_retrain_mean_sd_1['loss'].values,  #55
    pred_nn_retrain_mean_sd_2['loss'].values,   #56
    pred_xgb_retrain_mean_sd_2['loss'].values,  #57
    pred_nn_retrain_mean_sd_3['loss'].values,   #58
    pred_xgb_retrain_mean_sd_3['loss'].values,  #59
    pred_nn_retrain_mean_sd_4['loss'].values,   #60
    pred_xgb_retrain_mean_sd_4['loss'].values,  #61
    train['loss'].values
]
...
def f(coord,args):
    ...
    return np.mean( np.abs(
       coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5) + coord[pe*0+5]*np.sin(args[0]) + coord[pe*0+6]*np.cos(args[0])
     + coord[pe*1]*args[1] + coord[pe*1+1]*(args[1] ** 2) + coord[pe*1+2]*np.log(args[1]) + coord[pe*1+3]*1/(1.0+args[1]) + coord[pe*1+4]*(args[1] ** 0.5) + coord[pe*1+5]*np.sin(args[1]) + coord[pe*1+6]*np.cos(args[1])
     + coord[pe*2]*args[2] + coord[pe*2+1]*(args[2] ** 2) + coord[pe*2+2]*np.log(args[2]) + coord[pe*2+3]*1/(1.0+args[2]) + coord[pe*2+4]*(args[2] ** 0.5) + coord[pe*2+5]*np.sin(args[2]) + coord[pe*2+6]*np.cos(args[2])
     + coord[pe*3]*args[3] + coord[pe*3+1]*(args[3] ** 2) + coord[pe*3+2]*np.log(args[3]) + coord[pe*3+3]*1/(1.0+args[3]) + coord[pe*3+4]*(args[3] ** 0.5) + coord[pe*3+5]*np.sin(args[3]) + coord[pe*3+6]*np.cos(args[3])
     + coord[pe*4]*args[4] + coord[pe*4+1]*(args[4] ** 2) + coord[pe*4+2]*np.log(args[4]) + coord[pe*4+3]*1/(1.0+args[4]) + coord[pe*4+4]*(args[4] ** 0.5) + coord[pe*4+5]*np.sin(args[4]) + coord[pe*4+6]*np.cos(args[4])
     + coord[pe*5]*args[5] + coord[pe*5+1]*(args[5] ** 2) + coord[pe*5+2]*np.log(args[5]) + coord[pe*5+3]*1/(1.0+args[5]) + coord[pe*5+4]*(args[5] ** 0.5) + coord[pe*5+5]*np.sin(args[5]) + coord[pe*5+6]*np.cos(args[5])
     + coord[pe*6]*args[6] + coord[pe*6+1]*(args[6] ** 2) + coord[pe*6+2]*np.log(args[6]) + coord[pe*6+3]*1/(1.0+args[6]) + coord[pe*6+4]*(args[6] ** 0.5) + coord[pe*6+5]*np.sin(args[6]) + coord[pe*6+6]*np.cos(args[6])
     + coord[pe*7]*args[7] + coord[pe*7+1]*(args[7] ** 2) + coord[pe*7+2]*np.log(args[7]) + coord[pe*7+3]*1/(1.0+args[7]) + coord[pe*7+4]*(args[7] ** 0.5) + coord[pe*7+5]*np.sin(args[7]) + coord[pe*7+6]*np.cos(args[7])
     + coord[pe*8]*args[8] + coord[pe*8+1]*(args[8] ** 2) + coord[pe*8+2]*np.log(args[8]) + coord[pe*8+3]*1/(1.0+args[8]) + coord[pe*8+4]*(args[8] ** 0.5) + coord[pe*8+5]*np.sin(args[8]) + coord[pe*8+6]*np.cos(args[8])
     + coord[pe*9]*args[9] + coord[pe*9+1]*(args[9] ** 2) + coord[pe*9+2]*np.log(args[9]) + coord[pe*9+3]*1/(1.0+args[9]) + coord[pe*9+4]*(args[9] ** 0.5) + coord[pe*9+5]*np.sin(args[9]) + coord[pe*9+6]*np.cos(args[9])
     + coord[pe*10]*args[10] + coord[pe*10+1]*(args[10] ** 2) + coord[pe*10+2]*np.log(args[10]) + coord[pe*10+3]*1/(1.0+args[10]) + coord[pe*10+4]*(args[10] ** 0.5) + coord[pe*10+5]*np.sin(args[10]) + coord[pe*10+6]*np.cos(args[10])
     + coord[pe*11]*args[11] + coord[pe*11+1]*(args[11] ** 2) + coord[pe*11+2]*np.log(args[11]) + coord[pe*11+3]*1/(1.0+args[11]) + coord[pe*11+4]*(args[11] ** 0.5) + coord[pe*11+5]*np.sin(args[11]) + coord[pe*11+6]*np.cos(args[11])
     + coord[pe*12]*args[12] + coord[pe*12+1]*(args[12] ** 2) + coord[pe*12+2]*np.log(args[12]) + coord[pe*12+3]*1/(1.0+args[12]) + coord[pe*12+4]*(args[12] ** 0.5) + coord[pe*12+5]*np.sin(args[12]) + coord[pe*12+6]*np.cos(args[12])
     + coord[pe*13]*args[13] + coord[pe*13+1]*(args[13] ** 2) + coord[pe*13+2]*np.log(args[13]) + coord[pe*13+3]*1/(1.0+args[13]) + coord[pe*13+4]*(args[13] ** 0.5) + coord[pe*13+5]*np.sin(args[13]) + coord[pe*13+6]*np.cos(args[13])
     + coord[pe*14]*args[14] + coord[pe*14+1]*(args[14] ** 2) + coord[pe*14+2]*np.log(args[14]) + coord[pe*14+3]*1/(1.0+args[14]) + coord[pe*14+4]*(args[14] ** 0.5) + coord[pe*14+5]*np.sin(args[14]) + coord[pe*14+6]*np.cos(args[14])
     + coord[pe*15]*args[15] + coord[pe*15+1]*(args[15] ** 2) + coord[pe*15+2]*np.log(args[15]) + coord[pe*15+3]*1/(1.0+args[15]) + coord[pe*15+4]*(args[15] ** 0.5) + coord[pe*15+5]*np.sin(args[15]) + coord[pe*15+6]*np.cos(args[15])
     + coord[pe*16]*args[16] + coord[pe*16+1]*(args[16] ** 2) + coord[pe*16+2]*np.log(args[16]) + coord[pe*16+3]*1/(1.0+args[16]) + coord[pe*16+4]*(args[16] ** 0.5) + coord[pe*16+5]*np.sin(args[16]) + coord[pe*16+6]*np.cos(args[16])
     + coord[pe*17]*args[17] + coord[pe*17+1]*(args[17] ** 2) + coord[pe*17+2]*np.log(args[17]) + coord[pe*17+3]*1/(1.0+args[17]) + coord[pe*17+4]*(args[17] ** 0.5) + coord[pe*17+5]*np.sin(args[17]) + coord[pe*17+6]*np.cos(args[17])
     + coord[pe*18]*args[18] + coord[pe*18+1]*(args[18] ** 2) + coord[pe*18+2]*np.log(args[18]) + coord[pe*18+3]*1/(1.0+args[18]) + coord[pe*18+4]*(args[18] ** 0.5) + coord[pe*18+5]*np.sin(args[18]) + coord[pe*18+6]*np.cos(args[18])
     + coord[pe*19]*args[19] + coord[pe*19+1]*(args[19] ** 2) + coord[pe*19+2]*np.log(args[19]) + coord[pe*19+3]*1/(1.0+args[19]) + coord[pe*19+4]*(args[19] ** 0.5) + coord[pe*19+5]*np.sin(args[19]) + coord[pe*19+6]*np.cos(args[19])
     + coord[pe*20]*args[20] + coord[pe*20+1]*(args[20] ** 2) + coord[pe*20+2]*np.log(args[20]) + coord[pe*20+3]*1/(1.0+args[20]) + coord[pe*20+4]*(args[20] ** 0.5) + coord[pe*20+5]*np.sin(args[20]) + coord[pe*20+6]*np.cos(args[20])
     + coord[pe*21]*args[21] + coord[pe*21+1]*(args[21] ** 2) + coord[pe*21+2]*np.log(args[21]) + coord[pe*21+3]*1/(1.0+args[21]) + coord[pe*21+4]*(args[21] ** 0.5) + coord[pe*21+5]*np.sin(args[21]) + coord[pe*21+6]*np.cos(args[21])
     + coord[pe*22]*args[22] + coord[pe*22+1]*(args[22] ** 2) + coord[pe*22+2]*np.log(args[22]) + coord[pe*22+3]*1/(1.0+args[22]) + coord[pe*22+4]*(args[22] ** 0.5) + coord[pe*22+5]*np.sin(args[22]) + coord[pe*22+6]*np.cos(args[22])
     + coord[pe*23]*args[23] + coord[pe*23+1]*(args[23] ** 2) + coord[pe*23+2]*np.log(args[23]) + coord[pe*23+3]*1/(1.0+args[23]) + coord[pe*23+4]*(args[23] ** 0.5) + coord[pe*23+5]*np.sin(args[23]) + coord[pe*23+6]*np.cos(args[23])
     + coord[pe*24]*args[24] + coord[pe*24+1]*(args[24] ** 2) + coord[pe*24+2]*np.log(args[24]) + coord[pe*24+3]*1/(1.0+args[24]) + coord[pe*24+4]*(args[24] ** 0.5) + coord[pe*24+5]*np.sin(args[24]) + coord[pe*24+6]*np.cos(args[24])
     + coord[pe*25]*args[25] + coord[pe*25+1]*(args[25] ** 2) + coord[pe*25+2]*np.log(args[25]) + coord[pe*25+3]*1/(1.0+args[25]) + coord[pe*25+4]*(args[25] ** 0.5) + coord[pe*25+5]*np.sin(args[25]) + coord[pe*25+6]*np.cos(args[25])
     + coord[pe*26]*args[26] + coord[pe*26+1]*(args[26] ** 2) + coord[pe*26+2]*np.log(args[26]) + coord[pe*26+3]*1/(1.0+args[26]) + coord[pe*26+4]*(args[26] ** 0.5) + coord[pe*26+5]*np.sin(args[26]) + coord[pe*26+6]*np.cos(args[26])
     + coord[pe*27]*args[27] + coord[pe*27+1]*(args[27] ** 2) + coord[pe*27+2]*np.log(args[27]) + coord[pe*27+3]*1/(1.0+args[27]) + coord[pe*27+4]*(args[27] ** 0.5) + coord[pe*27+5]*np.sin(args[27]) + coord[pe*27+6]*np.cos(args[27])
     + coord[pe*28]*args[28] + coord[pe*28+1]*(args[28] ** 2) + coord[pe*28+2]*np.log(args[28]) + coord[pe*28+3]*1/(1.0+args[28]) + coord[pe*28+4]*(args[28] ** 0.5) + coord[pe*28+5]*np.sin(args[28]) + coord[pe*28+6]*np.cos(args[28])
     + coord[pe*29]*args[29] + coord[pe*29+1]*(args[29] ** 2) + coord[pe*29+2]*np.log(args[29]) + coord[pe*29+3]*1/(1.0+args[29]) + coord[pe*29+4]*(args[29] ** 0.5) + coord[pe*29+5]*np.sin(args[29]) + coord[pe*29+6]*np.cos(args[29])
     + coord[pe*30]*args[30] + coord[pe*30+1]*(args[30] ** 2) + coord[pe*30+2]*np.log(args[30]) + coord[pe*30+3]*1/(1.0+args[30]) + coord[pe*30+4]*(args[30] ** 0.5) + coord[pe*30+5]*np.sin(args[30]) + coord[pe*30+6]*np.cos(args[30])
     + coord[pe*31]*args[31] + coord[pe*31+1]*(args[31] ** 2) + coord[pe*31+2]*np.log(args[31]) + coord[pe*31+3]*1/(1.0+args[31]) + coord[pe*31+4]*(args[31] ** 0.5) + coord[pe*31+5]*np.sin(args[31]) + coord[pe*31+6]*np.cos(args[31])
     + coord[pe*32]*args[32] + coord[pe*32+1]*(args[32] ** 2) + coord[pe*32+2]*np.log(args[32]) + coord[pe*32+3]*1/(1.0+args[32]) + coord[pe*32+4]*(args[32] ** 0.5) + coord[pe*32+5]*np.sin(args[32]) + coord[pe*32+6]*np.cos(args[32])
     + coord[pe*33]*args[33] + coord[pe*33+1]*(args[33] ** 2) + coord[pe*33+2]*np.log(args[33]) + coord[pe*33+3]*1/(1.0+args[33]) + coord[pe*33+4]*(args[33] ** 0.5) + coord[pe*33+5]*np.sin(args[33]) + coord[pe*33+6]*np.cos(args[33])
     + coord[pe*34]*args[34] + coord[pe*34+1]*(args[34] ** 2) + coord[pe*34+2]*np.log(args[34]) + coord[pe*34+3]*1/(1.0+args[34]) + coord[pe*34+4]*(args[34] ** 0.5) + coord[pe*34+5]*np.sin(args[34]) + coord[pe*34+6]*np.cos(args[34])
     + coord[pe*35]*args[35] + coord[pe*35+1]*(args[35] ** 2) + coord[pe*35+2]*np.log(args[35]) + coord[pe*35+3]*1/(1.0+args[35]) + coord[pe*35+4]*(args[35] ** 0.5) + coord[pe*35+5]*np.sin(args[35]) + coord[pe*35+6]*np.cos(args[35])
     + coord[pe*36]*args[36] + coord[pe*36+1]*(args[36] ** 2) + coord[pe*36+2]*np.log(args[36]) + coord[pe*36+3]*1/(1.0+args[36]) + coord[pe*36+4]*(args[36] ** 0.5) + coord[pe*36+5]*np.sin(args[36]) + coord[pe*36+6]*np.cos(args[36])
     + coord[pe*37]*args[37] + coord[pe*37+1]*(args[37] ** 2) + coord[pe*37+2]*np.log(args[37]) + coord[pe*37+3]*1/(1.0+args[37]) + coord[pe*37+4]*(args[37] ** 0.5) + coord[pe*37+5]*np.sin(args[37]) + coord[pe*37+6]*np.cos(args[37])
     + coord[pe*38]*args[38] + coord[pe*38+1]*(args[38] ** 2) + coord[pe*38+2]*np.log(args[38]) + coord[pe*38+3]*1/(1.0+args[38]) + coord[pe*38+4]*(args[38] ** 0.5) + coord[pe*38+5]*np.sin(args[38]) + coord[pe*38+6]*np.cos(args[38])
     + coord[pe*39]*args[39] + coord[pe*39+1]*(args[39] ** 2) + coord[pe*39+2]*np.log(args[39]) + coord[pe*39+3]*1/(1.0+args[39]) + coord[pe*39+4]*(args[39] ** 0.5) + coord[pe*39+5]*np.sin(args[39]) + coord[pe*39+6]*np.cos(args[39])
     + coord[pe*40]*args[40] + coord[pe*40+1]*(args[40] ** 2) + coord[pe*40+2]*np.log(args[40]) + coord[pe*40+3]*1/(1.0+args[40]) + coord[pe*40+4]*(args[40] ** 0.5) + coord[pe*40+5]*np.sin(args[40]) + coord[pe*40+6]*np.cos(args[40])
     + coord[pe*41]*args[41] + coord[pe*41+1]*(args[41] ** 2) + coord[pe*41+2]*np.log(args[41]) + coord[pe*41+3]*1/(1.0+args[41]) + coord[pe*41+4]*(args[41] ** 0.5) + coord[pe*41+5]*np.sin(args[41]) + coord[pe*41+6]*np.cos(args[41])
     + coord[pe*42]*args[42] + coord[pe*42+1]*(args[42] ** 2) + coord[pe*42+2]*np.log(args[42]) + coord[pe*42+3]*1/(1.0+args[42]) + coord[pe*42+4]*(args[42] ** 0.5) + coord[pe*42+5]*np.sin(args[42]) + coord[pe*42+6]*np.cos(args[42])
     + coord[pe*43]*args[43] + coord[pe*43+1]*(args[43] ** 2) + coord[pe*43+2]*np.log(args[43]) + coord[pe*43+3]*1/(1.0+args[43]) + coord[pe*43+4]*(args[43] ** 0.5) + coord[pe*43+5]*np.sin(args[43]) + coord[pe*43+6]*np.cos(args[43])
     + coord[pe*44]*args[44] + coord[pe*44+1]*(args[44] ** 2) + coord[pe*44+2]*np.log(args[44]) + coord[pe*44+3]*1/(1.0+args[44]) + coord[pe*44+4]*(args[44] ** 0.5) + coord[pe*44+5]*np.sin(args[44]) + coord[pe*44+6]*np.cos(args[44])
     + coord[pe*45]*args[45] + coord[pe*45+1]*(args[45] ** 2) + coord[pe*45+2]*np.log(args[45]) + coord[pe*45+3]*1/(1.0+args[45]) + coord[pe*45+4]*(args[45] ** 0.5) + coord[pe*45+5]*np.sin(args[45]) + coord[pe*45+6]*np.cos(args[45])
     + coord[pe*46]*args[46] + coord[pe*46+1]*(args[46] ** 2) + coord[pe*46+2]*np.log(args[46]) + coord[pe*46+3]*1/(1.0+args[46]) + coord[pe*46+4]*(args[46] ** 0.5) + coord[pe*46+5]*np.sin(args[46]) + coord[pe*46+6]*np.cos(args[46])
...
initial_guess = np.array([np.random.uniform(-0.01,0.01) for x in range(pe * 47 + 13)])
...
pred_ensemble = (
       res.x[pe*0]*args[0] + res.x[pe*0+1]*(args[0] ** 2) + res.x[pe*0+2]*np.log(args[0]) + res.x[pe*0+3]*1/(1.0+args[0]) + res.x[pe*0+4]*(args[0] ** 0.5) + res.x[pe*0+5]*np.sin(args[0]) + res.x[pe*0+6]*np.cos(args[0])
     + res.x[pe*1]*args[1] + res.x[pe*1+1]*(args[1] ** 2) + res.x[pe*1+2]*np.log(args[1]) + res.x[pe*1+3]*1/(1.0+args[1]) + res.x[pe*1+4]*(args[1] ** 0.5) + res.x[pe*1+5]*np.sin(args[1]) + res.x[pe*1+6]*np.cos(args[1])
     + res.x[pe*2]*args[2] + res.x[pe*2+1]*(args[2] ** 2) + res.x[pe*2+2]*np.log(args[2]) + res.x[pe*2+3]*1/(1.0+args[2]) + res.x[pe*2+4]*(args[2] ** 0.5) + res.x[pe*2+5]*np.sin(args[2]) + res.x[pe*2+6]*np.cos(args[2])
     + res.x[pe*3]*args[3] + res.x[pe*3+1]*(args[3] ** 2) + res.x[pe*3+2]*np.log(args[3]) + res.x[pe*3+3]*1/(1.0+args[3]) + res.x[pe*3+4]*(args[3] ** 0.5) + res.x[pe*3+5]*np.sin(args[3]) + res.x[pe*3+6]*np.cos(args[3])
     + res.x[pe*4]*args[4] + res.x[pe*4+1]*(args[4] ** 2) + res.x[pe*4+2]*np.log(args[4]) + res.x[pe*4+3]*1/(1.0+args[4]) + res.x[pe*4+4]*(args[4] ** 0.5) + res.x[pe*4+5]*np.sin(args[4]) + res.x[pe*4+6]*np.cos(args[4])
     + res.x[pe*5]*args[5] + res.x[pe*5+1]*(args[5] ** 2) + res.x[pe*5+2]*np.log(args[5]) + res.x[pe*5+3]*1/(1.0+args[5]) + res.x[pe*5+4]*(args[5] ** 0.5) + res.x[pe*5+5]*np.sin(args[5]) + res.x[pe*5+6]*np.cos(args[5])
     + res.x[pe*6]*args[6] + res.x[pe*6+1]*(args[6] ** 2) + res.x[pe*6+2]*np.log(args[6]) + res.x[pe*6+3]*1/(1.0+args[6]) + res.x[pe*6+4]*(args[6] ** 0.5) + res.x[pe*6+5]*np.sin(args[6]) + res.x[pe*6+6]*np.cos(args[6])
     + res.x[pe*7]*args[7] + res.x[pe*7+1]*(args[7] ** 2) + res.x[pe*7+2]*np.log(args[7]) + res.x[pe*7+3]*1/(1.0+args[7]) + res.x[pe*7+4]*(args[7] ** 0.5) + res.x[pe*7+5]*np.sin(args[7]) + res.x[pe*7+6]*np.cos(args[7])
     + res.x[pe*8]*args[8] + res.x[pe*8+1]*(args[8] ** 2) + res.x[pe*8+2]*np.log(args[8]) + res.x[pe*8+3]*1/(1.0+args[8]) + res.x[pe*8+4]*(args[8] ** 0.5) + res.x[pe*8+5]*np.sin(args[8]) + res.x[pe*8+6]*np.cos(args[8])
     + res.x[pe*9]*args[9] + res.x[pe*9+1]*(args[9] ** 2) + res.x[pe*9+2]*np.log(args[9]) + res.x[pe*9+3]*1/(1.0+args[9]) + res.x[pe*9+4]*(args[9] ** 0.5) + res.x[pe*9+5]*np.sin(args[9]) + res.x[pe*9+6]*np.cos(args[9])
     + res.x[pe*10]*args[10] + res.x[pe*10+1]*(args[10] ** 2) + res.x[pe*10+2]*np.log(args[10]) + res.x[pe*10+3]*1/(1.0+args[10]) + res.x[pe*10+4]*(args[10] ** 0.5) + res.x[pe*10+5]*np.sin(args[10]) + res.x[pe*10+6]*np.cos(args[10])
     + res.x[pe*11]*args[11] + res.x[pe*11+1]*(args[11] ** 2) + res.x[pe*11+2]*np.log(args[11]) + res.x[pe*11+3]*1/(1.0+args[11]) + res.x[pe*11+4]*(args[11] ** 0.5) + res.x[pe*11+5]*np.sin(args[11]) + res.x[pe*11+6]*np.cos(args[11])
     + res.x[pe*12]*args[12] + res.x[pe*12+1]*(args[12] ** 2) + res.x[pe*12+2]*np.log(args[12]) + res.x[pe*12+3]*1/(1.0+args[12]) + res.x[pe*12+4]*(args[12] ** 0.5) + res.x[pe*12+5]*np.sin(args[12]) + res.x[pe*12+6]*np.cos(args[12])
     + res.x[pe*13]*args[13] + res.x[pe*13+1]*(args[13] ** 2) + res.x[pe*13+2]*np.log(args[13]) + res.x[pe*13+3]*1/(1.0+args[13]) + res.x[pe*13+4]*(args[13] ** 0.5) + res.x[pe*13+5]*np.sin(args[13]) + res.x[pe*13+6]*np.cos(args[13])
     + res.x[pe*14]*args[14] + res.x[pe*14+1]*(args[14] ** 2) + res.x[pe*14+2]*np.log(args[14]) + res.x[pe*14+3]*1/(1.0+args[14]) + res.x[pe*14+4]*(args[14] ** 0.5) + res.x[pe*14+5]*np.sin(args[14]) + res.x[pe*14+6]*np.cos(args[14])
     + res.x[pe*15]*args[15] + res.x[pe*15+1]*(args[15] ** 2) + res.x[pe*15+2]*np.log(args[15]) + res.x[pe*15+3]*1/(1.0+args[15]) + res.x[pe*15+4]*(args[15] ** 0.5) + res.x[pe*15+5]*np.sin(args[15]) + res.x[pe*15+6]*np.cos(args[15])
     + res.x[pe*16]*args[16] + res.x[pe*16+1]*(args[16] ** 2) + res.x[pe*16+2]*np.log(args[16]) + res.x[pe*16+3]*1/(1.0+args[16]) + res.x[pe*16+4]*(args[16] ** 0.5) + res.x[pe*16+5]*np.sin(args[16]) + res.x[pe*16+6]*np.cos(args[16])
     + res.x[pe*17]*args[17] + res.x[pe*17+1]*(args[17] ** 2) + res.x[pe*17+2]*np.log(args[17]) + res.x[pe*17+3]*1/(1.0+args[17]) + res.x[pe*17+4]*(args[17] ** 0.5) + res.x[pe*17+5]*np.sin(args[17]) + res.x[pe*17+6]*np.cos(args[17])
     + res.x[pe*18]*args[18] + res.x[pe*18+1]*(args[18] ** 2) + res.x[pe*18+2]*np.log(args[18]) + res.x[pe*18+3]*1/(1.0+args[18]) + res.x[pe*18+4]*(args[18] ** 0.5) + res.x[pe*18+5]*np.sin(args[18]) + res.x[pe*18+6]*np.cos(args[18])
     + res.x[pe*19]*args[19] + res.x[pe*19+1]*(args[19] ** 2) + res.x[pe*19+2]*np.log(args[19]) + res.x[pe*19+3]*1/(1.0+args[19]) + res.x[pe*19+4]*(args[19] ** 0.5) + res.x[pe*19+5]*np.sin(args[19]) + res.x[pe*19+6]*np.cos(args[19])
     + res.x[pe*20]*args[20] + res.x[pe*20+1]*(args[20] ** 2) + res.x[pe*20+2]*np.log(args[20]) + res.x[pe*20+3]*1/(1.0+args[20]) + res.x[pe*20+4]*(args[20] ** 0.5) + res.x[pe*20+5]*np.sin(args[20]) + res.x[pe*20+6]*np.cos(args[20])
     + res.x[pe*21]*args[21] + res.x[pe*21+1]*(args[21] ** 2) + res.x[pe*21+2]*np.log(args[21]) + res.x[pe*21+3]*1/(1.0+args[21]) + res.x[pe*21+4]*(args[21] ** 0.5) + res.x[pe*21+5]*np.sin(args[21]) + res.x[pe*21+6]*np.cos(args[21])
     + res.x[pe*22]*args[22] + res.x[pe*22+1]*(args[22] ** 2) + res.x[pe*22+2]*np.log(args[22]) + res.x[pe*22+3]*1/(1.0+args[22]) + res.x[pe*22+4]*(args[22] ** 0.5) + res.x[pe*22+5]*np.sin(args[22]) + res.x[pe*22+6]*np.cos(args[22])
     + res.x[pe*23]*args[23] + res.x[pe*23+1]*(args[23] ** 2) + res.x[pe*23+2]*np.log(args[23]) + res.x[pe*23+3]*1/(1.0+args[23]) + res.x[pe*23+4]*(args[23] ** 0.5) + res.x[pe*23+5]*np.sin(args[23]) + res.x[pe*23+6]*np.cos(args[23])
     + res.x[pe*24]*args[24] + res.x[pe*24+1]*(args[24] ** 2) + res.x[pe*24+2]*np.log(args[24]) + res.x[pe*24+3]*1/(1.0+args[24]) + res.x[pe*24+4]*(args[24] ** 0.5) + res.x[pe*24+5]*np.sin(args[24]) + res.x[pe*24+6]*np.cos(args[24])
     + res.x[pe*25]*args[25] + res.x[pe*25+1]*(args[25] ** 2) + res.x[pe*25+2]*np.log(args[25]) + res.x[pe*25+3]*1/(1.0+args[25]) + res.x[pe*25+4]*(args[25] ** 0.5) + res.x[pe*25+5]*np.sin(args[25]) + res.x[pe*25+6]*np.cos(args[25])
     + res.x[pe*26]*args[26] + res.x[pe*26+1]*(args[26] ** 2) + res.x[pe*26+2]*np.log(args[26]) + res.x[pe*26+3]*1/(1.0+args[26]) + res.x[pe*26+4]*(args[26] ** 0.5) + res.x[pe*26+5]*np.sin(args[26]) + res.x[pe*26+6]*np.cos(args[26])
     + res.x[pe*27]*args[27] + res.x[pe*27+1]*(args[27] ** 2) + res.x[pe*27+2]*np.log(args[27]) + res.x[pe*27+3]*1/(1.0+args[27]) + res.x[pe*27+4]*(args[27] ** 0.5) + res.x[pe*27+5]*np.sin(args[27]) + res.x[pe*27+6]*np.cos(args[27])
     + res.x[pe*28]*args[28] + res.x[pe*28+1]*(args[28] ** 2) + res.x[pe*28+2]*np.log(args[28]) + res.x[pe*28+3]*1/(1.0+args[28]) + res.x[pe*28+4]*(args[28] ** 0.5) + res.x[pe*28+5]*np.sin(args[28]) + res.x[pe*28+6]*np.cos(args[28])
     + res.x[pe*29]*args[29] + res.x[pe*29+1]*(args[29] ** 2) + res.x[pe*29+2]*np.log(args[29]) + res.x[pe*29+3]*1/(1.0+args[29]) + res.x[pe*29+4]*(args[29] ** 0.5) + res.x[pe*29+5]*np.sin(args[29]) + res.x[pe*29+6]*np.cos(args[29])
     + res.x[pe*30]*args[30] + res.x[pe*30+1]*(args[30] ** 2) + res.x[pe*30+2]*np.log(args[30]) + res.x[pe*30+3]*1/(1.0+args[30]) + res.x[pe*30+4]*(args[30] ** 0.5) + res.x[pe*30+5]*np.sin(args[30]) + res.x[pe*30+6]*np.cos(args[30])
     + res.x[pe*31]*args[31] + res.x[pe*31+1]*(args[31] ** 2) + res.x[pe*31+2]*np.log(args[31]) + res.x[pe*31+3]*1/(1.0+args[31]) + res.x[pe*31+4]*(args[31] ** 0.5) + res.x[pe*31+5]*np.sin(args[31]) + res.x[pe*31+6]*np.cos(args[31])
     + res.x[pe*32]*args[32] + res.x[pe*32+1]*(args[32] ** 2) + res.x[pe*32+2]*np.log(args[32]) + res.x[pe*32+3]*1/(1.0+args[32]) + res.x[pe*32+4]*(args[32] ** 0.5) + res.x[pe*32+5]*np.sin(args[32]) + res.x[pe*32+6]*np.cos(args[32])
     + res.x[pe*33]*args[33] + res.x[pe*33+1]*(args[33] ** 2) + res.x[pe*33+2]*np.log(args[33]) + res.x[pe*33+3]*1/(1.0+args[33]) + res.x[pe*33+4]*(args[33] ** 0.5) + res.x[pe*33+5]*np.sin(args[33]) + res.x[pe*33+6]*np.cos(args[33])
     + res.x[pe*34]*args[34] + res.x[pe*34+1]*(args[34] ** 2) + res.x[pe*34+2]*np.log(args[34]) + res.x[pe*34+3]*1/(1.0+args[34]) + res.x[pe*34+4]*(args[34] ** 0.5) + res.x[pe*34+5]*np.sin(args[34]) + res.x[pe*34+6]*np.cos(args[34])
     + res.x[pe*35]*args[35] + res.x[pe*35+1]*(args[35] ** 2) + res.x[pe*35+2]*np.log(args[35]) + res.x[pe*35+3]*1/(1.0+args[35]) + res.x[pe*35+4]*(args[35] ** 0.5) + res.x[pe*35+5]*np.sin(args[35]) + res.x[pe*35+6]*np.cos(args[35])
     + res.x[pe*36]*args[36] + res.x[pe*36+1]*(args[36] ** 2) + res.x[pe*36+2]*np.log(args[36]) + res.x[pe*36+3]*1/(1.0+args[36]) + res.x[pe*36+4]*(args[36] ** 0.5) + res.x[pe*36+5]*np.sin(args[36]) + res.x[pe*36+6]*np.cos(args[36])
     + res.x[pe*37]*args[37] + res.x[pe*37+1]*(args[37] ** 2) + res.x[pe*37+2]*np.log(args[37]) + res.x[pe*37+3]*1/(1.0+args[37]) + res.x[pe*37+4]*(args[37] ** 0.5) + res.x[pe*37+5]*np.sin(args[37]) + res.x[pe*37+6]*np.cos(args[37])
     + res.x[pe*38]*args[38] + res.x[pe*38+1]*(args[38] ** 2) + res.x[pe*38+2]*np.log(args[38]) + res.x[pe*38+3]*1/(1.0+args[38]) + res.x[pe*38+4]*(args[38] ** 0.5) + res.x[pe*38+5]*np.sin(args[38]) + res.x[pe*38+6]*np.cos(args[38])
     + res.x[pe*39]*args[39] + res.x[pe*39+1]*(args[39] ** 2) + res.x[pe*39+2]*np.log(args[39]) + res.x[pe*39+3]*1/(1.0+args[39]) + res.x[pe*39+4]*(args[39] ** 0.5) + res.x[pe*39+5]*np.sin(args[39]) + res.x[pe*39+6]*np.cos(args[39])
     + res.x[pe*40]*args[40] + res.x[pe*40+1]*(args[40] ** 2) + res.x[pe*40+2]*np.log(args[40]) + res.x[pe*40+3]*1/(1.0+args[40]) + res.x[pe*40+4]*(args[40] ** 0.5) + res.x[pe*40+5]*np.sin(args[40]) + res.x[pe*40+6]*np.cos(args[40])
     + res.x[pe*41]*args[41] + res.x[pe*41+1]*(args[41] ** 2) + res.x[pe*41+2]*np.log(args[41]) + res.x[pe*41+3]*1/(1.0+args[41]) + res.x[pe*41+4]*(args[41] ** 0.5) + res.x[pe*41+5]*np.sin(args[41]) + res.x[pe*41+6]*np.cos(args[41])
     + res.x[pe*42]*args[42] + res.x[pe*42+1]*(args[42] ** 2) + res.x[pe*42+2]*np.log(args[42]) + res.x[pe*42+3]*1/(1.0+args[42]) + res.x[pe*42+4]*(args[42] ** 0.5) + res.x[pe*42+5]*np.sin(args[42]) + res.x[pe*42+6]*np.cos(args[42])
     + res.x[pe*43]*args[43] + res.x[pe*43+1]*(args[43] ** 2) + res.x[pe*43+2]*np.log(args[43]) + res.x[pe*43+3]*1/(1.0+args[43]) + res.x[pe*43+4]*(args[43] ** 0.5) + res.x[pe*43+5]*np.sin(args[43]) + res.x[pe*43+6]*np.cos(args[43])
     + res.x[pe*44]*args[44] + res.x[pe*44+1]*(args[44] ** 2) + res.x[pe*44+2]*np.log(args[44]) + res.x[pe*44+3]*1/(1.0+args[44]) + res.x[pe*44+4]*(args[44] ** 0.5) + res.x[pe*44+5]*np.sin(args[44]) + res.x[pe*44+6]*np.cos(args[44])
     + res.x[pe*45]*args[45] + res.x[pe*45+1]*(args[45] ** 2) + res.x[pe*45+2]*np.log(args[45]) + res.x[pe*45+3]*1/(1.0+args[45]) + res.x[pe*45+4]*(args[45] ** 0.5) + res.x[pe*45+5]*np.sin(args[45]) + res.x[pe*45+6]*np.cos(args[45])
     + res.x[pe*46]*args[46] + res.x[pe*46+1]*(args[46] ** 2) + res.x[pe*46+2]*np.log(args[46]) + res.x[pe*46+3]*1/(1.0+args[46]) + res.x[pe*46+4]*(args[46] ** 0.5) + res.x[pe*46+5]*np.sin(args[46]) + res.x[pe*46+6]*np.cos(args[46])
...
args = [
    ...
    pred_nn['loss'],             #48
    pred_xgb['loss'],            #49
    pred_nn_gmean['loss'],       #50
    pred_xgb_gmean['loss'],      #51
    pred_nn_sd['loss'],          #52
    pred_xgb_sd['loss'],         #53
    pred_nn_mean_sd_1['loss'],   #54
    pred_xgb_mean_sd_1['loss'],  #55
    pred_nn_mean_sd_2['loss'],   #56
    pred_xgb_mean_sd_2['loss'],  #57
    pred_nn_mean_sd_3['loss'],   #58
    pred_xgb_mean_sd_3['loss'],  #59
    pred_nn_mean_sd_4['loss'],   #60
    pred_xgb_mean_sd_4['loss'],  #61
    train['loss']
]
