...
args = [
    ...
    pred_xgb_17_retrain['loss'].values,         #29
    train['loss'].values
]
...
def f(coord,args):
    ...
    return np.mean( np.abs(coord[pe*0]*args[0] + coord[pe*0+1]*(args[0] ** 2) + coord[pe*0+2]*np.log(args[0]) + coord[pe*0+3]*1/(1.0+args[0]) + coord[pe*0+4]*(args[0] ** 0.5)
     ...
     + coord[pe*28]*args[28] + coord[pe*28+1]*(args[28] ** 2) + coord[pe*28+2]*np.log(args[28]) + coord[pe*28+3]*1/(1.0+args[27]) + coord[pe*28+4]*(args[28] ** 0.5)
     + coord[pe*29+0]*(args[23] - args[16])
     + coord[pe*29+1]*(abs(args[23] - args[16]))
     + coord[pe*29+2]*((args[23]-args[16]) ** 2)
     + coord[pe*29+3]*np.log(abs(args[23]-args[16]))
     + coord[pe*29+4]*1/(1.0+args[23]-args[16])
     + coord[pe*29+5]*1/(1.0+abs(args[23]-args[16]))
     + coord[pe*29+6]*(abs(args[23]-args[16]) ** 0.5)
     + coord[pe*29+7]*(args[26] - args[16])
     + coord[pe*29+8]*(abs(args[26] - args[16]))
     + coord[pe*29+9]*((args[26]-args[16]) ** 2)
     + coord[pe*29+10]*np.log(abs(args[26]-args[16]))
     + coord[pe*29+11]*1/(1.0+args[26]-args[16])
     + coord[pe*29+12]*1/(1.0+abs(args[26]-args[16]))
     + coord[pe*29+13]*(abs(args[26]-args[23]) ** 0.5)
     + coord[pe*29+14]*(args[26] - args[23])
     + coord[pe*29+15]*(abs(args[26] - args[23]))
     + coord[pe*29+16]*((args[26]-args[23]) ** 2)
     + coord[pe*29+17]*np.log(1+abs(args[26]-args[23]))
     + coord[pe*29+18]*1/(1.0+(args[26]-args[23]))
     + coord[pe*29+19]*1/(1.0+abs(args[26]-args[23]))
     + coord[pe*29+20]*(abs(args[26]-args[23]) ** 0.5)
     + coord[pe*29+21]*(args[28] - args[16])
     + coord[pe*29+22]*(abs(args[28] - args[16]))
     + coord[pe*29+23]*((args[28]-args[16]) ** 2)
     + coord[pe*29+24]*np.log(1+abs(args[28]-args[16]))
     + coord[pe*29+25]*1/(1.0+(args[28]-args[16]))
     + coord[pe*29+26]*1/(1.0+abs(args[28]-args[16]))
     + coord[pe*29+27]*(abs(args[28]-args[16]) ** 0.5)
     + coord[pe*29+28]*(args[28] - args[23])
     + coord[pe*29+29]*(abs(args[28] - args[23]))
     + coord[pe*29+30]*((args[28]-args[23]) ** 2)
     + coord[pe*29+31]*np.log(1+abs(args[28]-args[23]))
     + coord[pe*29+32]*1/(1.0+(args[28]-args[23]))
     + coord[pe*29+33]*1/(1.0+abs(args[28]-args[23]))
     + coord[pe*29+34]*(abs(args[28]-args[23]) ** 0.5)
     + coord[pe*29+35]*(args[28] - args[26])
     + coord[pe*29+36]*(abs(args[28] - args[26]))
     + coord[pe*29+37]*((args[28]-args[26]) ** 2)
     + coord[pe*29+38]*np.log(1+abs(args[28]-args[26]))
     + coord[pe*29+39]*1/(1.0+(args[28]-args[26]))
     + coord[pe*29+40]*1/(1.0+abs(args[28]-args[26]))
     + coord[pe*29+41]*(abs(args[28]-args[26]) ** 0.5)
     + coord[pe*29+42]
     - args[-1]) )


initial_guess = np.array([0.1 for x in range(pe * 29 + 43)])
